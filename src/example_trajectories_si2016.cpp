...
int main(int argc, char** argv){
	...
	// ros::Subscriber sub_ekf = n.subscribe("/lcl5", 10, ekf_callback);
	ros::Subscriber sub_ekf = n.subscribe("/ekf_DgaussAndNDT", 10, ekf_callback);
	// ros::Subscriber sub_amu = n.subscribe("/lcl3", 10, amu_callback);
	// ros::Subscriber sub_tiny = n.subscribe("/lcl2", 10, tiny_callback);
	...
	ros::Publisher pub_line_ekf = n.advertise<visualization_msgs::Marker>("/ekf_trajectory/4", 1);
	// ros::Publisher pub_line_tiny = n.advertise<visualization_msgs::Marker>("/tiny_trajectory/1", 1);
	// ros::Publisher pub_line_amu = n.advertise<visualization_msgs::Marker>("/amu_trajectory/1", 1);
	...
	// line_ekf.color.r = 1.0f; // original
	// line_ekf.color.g = 1.0f;
	// Vline_ekf.color.a = 1.0;

	// line_ekf.color.r = 0.5f; // grey
	// line_ekf.color.g = 0.5f;
	// line_ekf.color.b = 0.5f;
	// line_ekf.color.a = 1.0;

	// line_ekf.color.r = 0.6f; // red
	// line_ekf.color.g = 0.0f;
	// line_ekf.color.b = 0.0f;
	// line_ekf.color.a = 1.0;

	// line_ekf.color.r = 0.0f; // blue
	// line_ekf.color.g = 0.0f;
	// line_ekf.color.b = 0.6f;
	// line_ekf.color.a = 1.0;
	
	// line_ekf.color.r = 0.6f; // pink
	// line_ekf.color.g = 0.0f;
	// line_ekf.color.b = 0.6f;
	// line_ekf.color.a = 1.0;

	line_ekf.color.r = 0.0f; // green
	line_ekf.color.g = 0.6f;
	line_ekf.color.b = 0.0f;
	line_ekf.color.a = 1.0;
